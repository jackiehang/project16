...
//    private Integer errorCounter = 0;
    ...
    /**
     * scan and parse the selected CodeArea, pass the AST generated by the parser to MainMainVisitor.
     * print the output of the method in the console pane
     */
    public void handleCheckMain(){
        this.parseIsDone = false;
        new Thread (()->{
            ParseTask parseTask = new ParseTask();
            FutureTask<Program> curFutureTask = new FutureTask<Program>(parseTask);
    ...
    /**
     * scan and parse the selected CodeArea, pass the AST generated by the parser to StringConstantsVisitor.
     * print the output of the method in the console pane
     */
    public void handleCheckString(){
        this.parseIsDone = false;
        new Thread (()->{
            ParseTask parseTask = new ParseTask();
            FutureTask<Program> curFutureTask = new FutureTask<Program>(parseTask);
    ...
    /**
     * scan and parse the selected CodeArea, pass the AST generated by the parser to NumLocalVarsVisitor.
     * print the output of the method in the console pane
     */
