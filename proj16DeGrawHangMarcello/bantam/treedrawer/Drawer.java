...
package proj16DeGrawHangMarcello.bantam.treedrawer;

import proj16DeGrawHangMarcello.JavaCodeArea;
...
public class Drawer
{
    ...
    public void draw(String sourceName, Program AST)
    {
        ...
        proj16DeGrawHangMarcello.bantam.treedrawer.LayoutVisitor layout =
                new LayoutVisitor(fontMetrics);

        proj16DeGrawHangMarcello.bantam.treedrawer.DrawingTree theDrawing =
