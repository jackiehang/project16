...
package proj15DeGrawHangMarcello.bantam.ast;
...
public class UnaryIncrExpr extends UnaryExpr {
     ...
     */
    public UnaryIncrExpr(int lineNum, int colPos,  Expr expr, boolean isPostfix) {
        super(lineNum,colPos, expr);
     ...
     * @see proj15DeGrawHangMarcello.bantam.visitor.Visitor
     */
